...
3. When the popup appears, select the accept-sagepay-payments-using-contact-form-7.zip file from your desktop.
...
That's it! Just configure your settings as you see fit, and you're on your way to creating forms with SagePay in your style.

= Getting Help From Our Support System =

Furthermore, suppose you need technical assistance to integrate ‘Accept SagePay Payments Using Contact Form 7’. In that case, you can reach out to us at https://zealousweb.com/support/, ZealousWeb Support System, and our support team will lend you the necessary assistance. As a leading company providing digital solutions and the developers of this plugin, we ensure our clients have a seamless experience with ‘Accept SagePay Payments Using Contact Form 7’.
...
= How to add SagePay payment information in email body? =

For you need to add "[sagepay-payment-details]" tag in email body.

= How to display SagePay payment information after success payment? =

For that you need to add "[sagepay-details]" tag in page.

== Screenshots ==

1. SagePay Demo Form
2. SagePay Settings and Configuration
3. SagePay Amount Field Configuration
4. SagePay Payment Detail Page
